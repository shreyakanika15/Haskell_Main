...
/* package HaskellIndividual-0.1.0.0 */
#define VERSION_HaskellIndividual "0.1.0.0"
#define MIN_VERSION_HaskellIndividual(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HaskellIndividual-0.1.0.0-Jth6fFVBPrFObf4MxmqTY"

#define CURRENT_PACKAGE_KEY "HaskellIndividual-0.1.0.0-Jth6fFVBPrFObf4MxmqTY"
